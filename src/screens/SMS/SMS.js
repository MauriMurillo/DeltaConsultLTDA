    ...
    <div className="smsScreen Screen">
      ...
      <div className="pane2" style={{ marginTop: "0px" }}>
        ...
        <div className="TextDelta">
          ...
          necesidades de nuestros clientes en todo el continente. Privilegiamos
          los conocimientos y las experiencias nacionales para resolver las
          problemáticas y las complejidades de las compañías que operan en la
          región, sea cual fuere su origenBasamos nuestro éxito en el
          conocimiento específico de cada país, su entrono y sus empresas, para
          poder dar siempre la respuesta adecuada a cada situación.Y esto se
          logra únicamente perteneciendo y siendo parte activa de la región
        </div>
      </div>
